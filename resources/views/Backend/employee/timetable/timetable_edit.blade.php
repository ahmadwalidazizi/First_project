				...
				<div class="page-header">
                    ...
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Teacher Timetable</li>
                        </ol>
                    </div>
                    <!-- PAGE-HEADER END -->
				</div>
					...
					<div class="col-md-12 col-lg-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Teacher Timetable Update</h3>
							</div>
                            <div class="card-body">									
								<form action="{{route('teacher.timetable.update', $editData['0']->employee_id)}}" method="post" class="form-group">
    								@csrf
									<div class="row">
													...
													<div class="col-lg-12">
														...
														<div class="input-group">
                                                            ...
                                                            <select class="form-control select2"  name="employee_id" disable="">
                                                                ...
                                                                <option value="{{$teacher -> id}}" {{($editData['0']->employee_id == $teacher->id)? "selected" : ""}}> {{$teacher ['employee']['name']}} </option>
                                                                @endforeach
                                                            </select>
														</div>
													</div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-lg-12">
                                                                            <label>Teacher:</label>
                                                                            <div class="input-group">
                                                                                <select class="form-control select2"  name="class_1[]" id="class_1">
                                                                                    <option value="" selected="" disabled="">Class</option>
                                                                                    @foreach($classes as $class)
                                                                                    <option value="{{$class -> id}}" {{($edit->class_1 == $class -> id)?"selected":""}}> {{$class->name}} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            <label>Subject:</label>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-lg-12">
                                                                            <label>Class:</label>
                                                                            <div class="input-group">
                                                                                <select class="form-control select2"  name="class_2[]" id="class_2">
                                                                                    <option value="" selected="" disabled="">Class</option>
                                                                                    @foreach($classes as $class)
                                                                                    <option value="{{$class -> id}}" {{($edit->class_2 == $class -> id)?"selected":""}}> {{$class->name}} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            <label>Subject:</label>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-lg-12">
                                                                            <label>Class:</label>
                                                                            <div class="input-group">
                                                                                <select class="form-control select2"  name="class_3[]" id="class_3">
                                                                                    <option value="" selected="" disabled="">Class</option>
                                                                                    @foreach($classes as $class)
                                                                                    <option value="{{$class -> id}}" {{($edit->class_3 == $class -> id)?"selected":""}}> {{$class->name}} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            <label>Subject:</label>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-lg-12">
                                                                            <label>Class:</label>
                                                                            <div class="input-group">
                                                                                <select class="form-control select2"  name="class_4[]" id="class_4">
                                                                                    <option value="" selected="" disabled="">Class</option>
                                                                                    @foreach($classes as $class)
                                                                                    <option value="{{$class -> id}}" {{($edit->class_4 == $class -> id)?"selected":""}}> {{$class->name}} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            <label>Subject:</label>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-lg-12">
                                                                            <label>Class:</label>
                                                                            <div class="input-group">
                                                                                <select class="form-control select2"  name="class_5[]" id="class_5">
                                                                                    <option value="" selected="" disabled="">Class</option>
                                                                                    @foreach($classes as $class)
                                                                                    <option value="{{$class -> id}}" {{($edit->class_5 == $class -> id)?"selected":""}}> {{$class->name}} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            <label>Subject:</label>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-lg-12">
                                                                            <label>Class:</label>
                                                                            <div class="input-group">
                                                                                <select class="form-control select2"  name="class_6[]" id="class_6">
                                                                                    <option value="" selected="" disabled="">Class</option>
                                                                                    @foreach($classes as $class)
                                                                                    <option value="{{$class -> id}}" {{($edit->class_6 == $class -> id)?"selected":""}}> {{$class->name}} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            <label>Subject:</label>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-lg-12">
                                                                            <label>Class:</label>
                                                                            <div class="input-group">
                                                                                <select class="form-control select2"  name="class_7[]" id="class_7">
                                                                                    <option value="" selected="" disabled="">Class</option>
                                                                                    @foreach($classes as $class)
                                                                                    <option value="{{$class -> id}}" {{($edit->class_7 == $class -> id)?"selected":""}}> {{$class->name}} </option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                            <label>Subject:</label>

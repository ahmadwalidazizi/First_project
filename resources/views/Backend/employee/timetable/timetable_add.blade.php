				...
				<div class="page-header">
                    ...
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('teacher.timetable.view')}}">Teachers Timetable</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Add Teacher Timetable</li>
                        </ol>
                    </div>
                    <!-- PAGE-HEADER END -->
				</div>
				 ...
				 <div class="row">
					<div class="col-md-12 col-lg-12">
						<div class="card">
                            ...
                            <div class="card-body">									
								<form action="{{route('teacher.timetable.store')}}" method="post" class="form-group">
    								@csrf
									<div class="row">

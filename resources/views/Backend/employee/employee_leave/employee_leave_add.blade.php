					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							<div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{route('employee.leave.store')}}" method="post" class="form-group" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <label> Name:</label>
                                            ...
                                            <div class="col-lg-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" name="start_date" id="increment_salary" class="form-control" require>
											    </div>
                                            </div>
                                            <div class="col-lg-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" name="end_date" id="effected_salary" class="form-control" require>
											    </div>
                                            </div>
                                            <div class="col-lg-2">

					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							<div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{route('employee.increment.update', $editData -> id)}}" method="post" class="form-group" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label> Reason:</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="increment_reason" id="increment_reason" class="form-control" placeholder="Enter the increment reason" require>
											    </div>
                                            </div>
                                            <div class="col-lg-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="increment_salary" id="increment_salary" class="form-control" placeholder="Enter the increment amount" require>
											    </div>
                                            </div>
                                            <div class="col-lg-5">

				...
				<div class="page-header">
                    ...
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Employee Attendance </li>
                        </ol>
                    </div>
                </div>
                    <!-- ROW-1 OPEN -->
						...
						<div class="col-md-12 col-lg-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">Employee Attendance Update</h3>
								</div>
                                <div class="card-body">
                                    ...
                                    @csrf
                                        <div class="row">
                                                ...
                                                <div class="table-responsive">
                                                    <table id="example" class="table table-striped table-bordered table-hover">
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                <th class="text-center btn btn-info present_all" style="display: table-cell;">Present</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr id="div{{$data->id}}" class="text-center">
                                                                ...
                                                                <td>{{ $key+1  }}</td>
                                                                <td>
                                                                <img src="{{ (!empty($data ['user']['image']))? url('upload/employee_images/'.$data ['user']['image']):url('upload/user.png') }}" 
                                                                style="width: 50px; width: 50px; border-radius:50%;"> 
                                                                </td>
                                                                <td style="text-align:left;">{{ $data ['user']['id_no'] }}</td>
                                            ...
                                            <button class="btn btn-info" style="width: 50px;
                                                ...
                                                outline: blue;
                                                border: none;
                                                cursor: pointer;"><i class="fa fa-edit"></i></button> 
                                        </div>
                                    </form>
                                </div>
							<!-- TABLE WRAPPER -->

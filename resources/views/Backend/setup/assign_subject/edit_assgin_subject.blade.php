				...
				<div class="page-header">
                    ...
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('assign.subject.view')}}">Assign Subject</a> </li>
                            <li class="breadcrumb-item active" aria-current="page">Eidt Assign Subject</li>
                        </ol>
                    </div>
                    <!-- PAGE-HEADER END -->
				</div>
				 ...
				 <div class="row">
					<div class="col-md-12 col-lg-12">
						<div class="card">
                            ...
                            <div class="card-body">									
								<form action="{{ route('assign.subject.update',$editData[0]->class_id) }}" method="post" class="form-group">
    								@csrf
									<div class="row">
													...
													<div class="col-lg-6">
														...
														<div class="input-group">
															...
															<select class="form-control select2"  name="negaran">
                                                                <option selected="" disabled=""> Choose Negaran</option>
                                                                @foreach($teachers as $teacher)
																<option value="{{$teacher->id}}" {{($editData['1'] -> teacher_id == $teacher->id) ? "selected" : ""}} >{{$teacher->name}}</option>
                                                                @endforeach
                                                            </select>
														</div>
													</div>
													@foreach($editData as $edit)
													<div class="row delete_whole_extra_item" id="delete_whole_extra_item">
													<div class="col-lg-3">

				...
				<div class="page-header">
                    ...
                    <div>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('student.marks.view')}}">Students Marks View</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Update Marks Entry</li>
                        </ol>
                    </div>
                    <!-- PAGE-HEADER END -->
				</div>
     ...
     $.ajax({
      ...
      success: function (data) {
        ...
        $.each( data, function(key, v){
          ...
          '<td><input type="number" class="form-control " name="marks[]" value="'+v.marks+'" ></td>'+
          '</tr>';
        });
